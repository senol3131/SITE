...
<div class="content-title">
	<h1 class="title"><center>DROP ARAMA</center></h1>
</div><!-- content-title -->
...
<form class="form-horizontal" role="form" method="post" onsubmit="return false;">
	<div class="label-left list-bordered">
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="search_query" id="search_query" placeholder="Yaratık adı giriniz" autocomplete="off" maxlength="40" style="border: 1px solid rgb(35, 52, 66);"/>
			</div>
        </div>
		<br>
        <div class="form-group">
            <div class="row margin-top20">
                <div class="col-md-12 col-md-offset-8">
					<div class="lins-top-news">
						...
						<button class="login-button2 button-n" name="search_button" style="background: url(<?=$path;?>images/register-button.jpg) no-repeat;box-shadow: 0px 0px 29px 1px #4f0634;border: 1px solid #2f0128;" id="search_button" type="button" onclick="searchDrop();">Arama</button>
					</div>	
                </div>	
            </div>
        </div>
