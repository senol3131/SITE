...
<div class="content-title">
	<h1 class="title"><center>Seviye Sıralaması</center></h1>
</div><!-- content-title -->
...
<?php
					$i = 0;
					$ss = "SELECT TOP 100 UD.strUserID, UD.Class, UD.Level, UD.bRebirthLevel, UD.Nation, UD.Loyalty, UD.Knights, KD.IDNUM, KD.IDName AS KnightName, UD.LoyaltyMonthly FROM USERDATA AS UD LEFT JOIN KNIGHTS AS KD ON UD.Knights = KD.IDNUM WHERE UD.AUTHORITY = 1 ORDER BY UD.Level DESC";
